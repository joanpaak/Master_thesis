...
I will present trial-by-trial estimates and a more detailed analysis of differences during the last trial.
...
Similar pattern can be observed for the squared errors (Figures \ref{fig:qs_YN_sq_error} and \ref{fig:qs_AFC_sq_error})  but the differences are swamped by lot more variability. 
