...
% Will prevent footnotes from being split:
...
encoding = 'UTF-8'
setwd("~/Documents/GitHub_keskeneräisiä_paljon/Master_thesis/PDF")
...
\newpage
<<background_Bayes, child='Intro_and_Background/Theoretical_background_4_Bayes_old.Rnw'>>=
@
