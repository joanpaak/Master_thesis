...
save(post_pred_YN_obs, 
     file = "analysis_files/OK/post_pred_YN_obs.rData")

save(post_pred_YN_model_1, 
     file = "analysis_files/OK/post_pred_YN_model_1.rData")
save(post_pred_YN_model_2, 
     file = "analysis_files/OK/post_pred_YN_model_2.rData")
save(post_pred_YN_model_3, 
     file = "analysis_files/OK/post_pred_YN_model_3.rData")

save(post_pred_YN_both, 
     file = "analysis_files/OK/post_pred_YN_both.rData")
...
save(post_pred_AFC_obs, 
     file = "analysis_files/OK/post_pred_AFC_obs.rData")

save(post_pred_AFC_model_1, 
     file = "analysis_files/OK/post_pred_AFC_model_1.rData")
save(post_pred_AFC_model_2, 
     file = "analysis_files/OK/post_pred_AFC_model_2.rData")
save(post_pred_AFC_model_3, 
     file = "analysis_files/OK/post_pred_AFC_model_3.rData")

save(post_pred_AFC_both, 
     file = "analysis_files/OK/post_pred_AFC_both.rData")
