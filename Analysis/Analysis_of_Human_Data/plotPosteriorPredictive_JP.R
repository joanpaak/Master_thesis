...
for(fname in dir("analysis_files/JP/", pattern = "post_pred")){
...
png(file = "../../PDF/figures/JP_YN_post_pred.png", 
    width = 10, 
    height = 7, 
    units = "in", 
    res = 700)
...
png(file = "../../PDF/figures/JP_AFC_post_pred.png", 
    width = 10,
    height = 7,
    units = "in",
    res = 700)
...
png(file = "../../PDF/figures/JP_post_pred_both_truncated.png", 
    width = 10,
    height = 10,
    units = "in",
    res = 700)
...
par(mfrow = c(2,2))
plotRepData(post_pred_YN_both_T, post_pred_YN_obs, "x")
mtext("Yes/No, Both interactions (Truncated)", side = 3, line = 1, adj = 0)
mtext("P(Correct) Pitch", 2, line = 2.5)
plotRepData(post_pred_YN_both_T, post_pred_YN_obs, "y")
mtext("P(Correct) Timbre", 2, line = 2.5)

plotRepData(post_pred_AFC_both_T, post_pred_AFC_obs, "x")
mtext("2I-4AFC, Both interactions (Truncated)", side = 3, line = 1, adj = 0)
mtext("P(Correct) Pitch", 2, line = 2.5)
plotRepData(post_pred_AFC_both_T, post_pred_AFC_obs, "y")
mtext("P(Correct) Timbre", 2, line = 2.5)
